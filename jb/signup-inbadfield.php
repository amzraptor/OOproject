...
<div style="width=100%">
<div style="height=40px;width:40%;margin-top:20px;">
<form style="height=40px;border-style:solid;margin-top:10px;">
...
<form action="main.php" method="POST" style="height=400px;border-style:solid;padding-top:10px;padding-left:30px;">
