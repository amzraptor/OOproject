...
<div id="store_category" name="store_category" style="float:left;width:100%;margin-left:15%;">
...
<!--save-->
<button name="save_vendor_information" id="save_vinfo" style="margin-left:5%;">save</button></br>
</div>
    </div>
...
<!--save-->
<button name="save_store_information" id="save_sinfo" style="margin-left:5%;">save</button></br>
</div>
    </div>
</div>
</div>
...
save_info('lfont', font);
        ...
        $("#save_store_information").click(function () {
...
save_info('description', $('#description').val());
        ...
        $("#save_vendor_information").click(function () {
