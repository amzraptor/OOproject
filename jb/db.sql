...
INSERT INTO product(name,category,material,size,gender,price,img1,qty,description,store_id)
VALUES('prison shank', 'other', 'other', 'large', 'unisex', 11.99, 'images/Default_Pic.png', 2, 'A cool shank for men to get people. You want one!', 7);
...
INSERT INTO product(name,category,material,size,gender,price,img1,qty,description,store_id)
VALUES('Kids\'s tongue stud', 'body jewelry', 'silver', 'large', 'unisex', 4.20, 'images/Default_Pic.png',200, 'A cool thing for you kid. You want one!', 1);
