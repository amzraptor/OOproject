...
//add_cart("bdpoag1");
/*function add_cart($username)
{
    $fields = array("user_username");
    $values = array($username);
    return add("cart", $fields, $values);
}*/
//echo"hey1";
/*$x = save_vinfo(1, "n", "n", "n", "n",  "65203", "n");
if ($x == false) echo"hey2";
else echo"hey3";*/
...
/*function save_vinfo($store, $semail, $street_address, $city, $state, $zip, $phone_number)
{
    $setfields = array("semail", "street_address", "city,", "state", "zip", "phone_number");
    $setvalues = array($semail,$street_address, $city, $state, $zip, $phone_number); 
    $wherefields = array("store_id");
    $wherevalues = array($store);
    return update("store", $setfields, $setvalues, $wherefields, $wherevalues);
}*/
/*$x = save_vinfo(1,"semail", "brandy");
echo "here $x";
if ($x == false) echo"y";
echo"hey";*/
function save_sinfo( $owner, $specialty, $bio,  $sname, $shipping)
{


    $setfields = array("owner", "specialty", "description", "name", "shipping");
    $setvalues = array($owner, $specialty, $bio,  $sname, $shipping); 
    $wherefields = array("store_id");
    $wherevalues = array($store);
    return update("store", $setfields, $setvalues, $wherefields, $wherevalues);
}
