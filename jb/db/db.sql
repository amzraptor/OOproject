...
CREATE TABLE IF NOT EXISTS rating(
    rating_id	MEDIUMINT 	NOT NULL AUTO_INCREMENT PRIMARY KEY,
    product_id	MEDIUMINT	NOT NULL,
...
INSERT INTO product(name,category,material,size,gender,price,img1,qty,description,store_id)
VALUES('Kids\'s rings', 'rings', 'silver', 'small', 'unisex', 4.20, '/var/www/html/Default_Pic.png',200, 'A cool ring for you kid. You want one!', 1);

INSERT INTO product(name,category,material,size,gender,price,img1,qty,description,store_id)
VALUES('Women\'s necklace','necklaces','wood','18','woman',19.98,'/var/www/html/Default_Pic.png',20,'A cool necklace for women to wear. You want one!',2);

INSERT INTO product(name,category,material,size,gender,price,img1,qty,description,store_id)
VALUES('Kids\'s rings', 'rings', 'silver', 'small', 'unisex', 4.20, '/var/www/html/Default_Pic.png',200, 'A cool ring for you kid. You want one!', 2);
